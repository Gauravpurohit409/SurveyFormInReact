...
const Multiselect = (props) => {
    ...
    <MultiselectOptions moreOptions = {moreOptions} id = {e.id} deleteOptions = {deleteLocalOptions} updateAnswers = {updateAnswers} answers ={props.answers.filter((ans) => ans.id === ("Multi_"+e.id))}/>
    )
    :(
        moreOptions()
    );
